...
METADATA_PATH = "models/xgboost_tuned_pipeline_metadata.pkl"
...
# ── Tabs ───────────────────────────────────────────────────────────────────
tab_manual, tab_csv, tab_insight, tab_about = st.tabs([
    "✏️ Single Property",
    "📂 Batch Prediction",
    "📊 Market Insights",
    "ℹ️ About",
...
with tab_csv:
    ...
    st.caption("Use this when you have **multiple properties** to evaluate at once. Upload a CSV file with one property per row and get market value estimates for all of them in a single run.")
    st.divider()
...
# ═══════════════════════════════════════════════════════════════════════════
with tab_manual:
    st.subheader("✏️ Single Property Prediction")
    st.caption("Use this when you want to estimate the market value of **one specific property**. Fill in the fields below and click Predict — all fields are pre-loaded with example values so you can get started right away.")
    st.divider()
